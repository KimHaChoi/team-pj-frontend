...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/85 backdrop-blur-md border-t border-slate-100 shadow-[0_-4px_24px_rgba(0,0,0,0.04)] px-2 py-1 pb-safe md:hidden">
